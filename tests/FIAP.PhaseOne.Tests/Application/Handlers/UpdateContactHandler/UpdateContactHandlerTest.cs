...
namespace FIAP.Contacts.Update.Tests.Application.Handlers.UpdateContactHandler
{
    public class UpdateContactHandlerTest : ApplicationTest
    {
        ...
        public async Task UpdateContact_WithValidData_Succeeded()
        {
            ...
            {
                Id = id,
                Contact = new Update.Application.Handlers.Commands.UpdateContact.Dto.ContactForUpdateDto(
